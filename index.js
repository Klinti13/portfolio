...
const projectData = {
    ...
    icons:`<i class="fa-brands fa-react" style="color: #61DBFB;"></i> <i class="devicon-typescript-plain" style="color: #3178C6;"></i> <i class="devicon-tailwindcss-original" style="color: #38BDF8;"></i>`
    }
};
