...
const projectData = {
    ...
    icons:`<i class="fa-brands fa-react" style="color: #61DBFB;"></i> <i class="fa-brands fa-typescript" style="color: #3178C6;"></i> <i class="fa-solid fa-tailwind-css" style="color: #38BDF8;"></i>`
    }
};
